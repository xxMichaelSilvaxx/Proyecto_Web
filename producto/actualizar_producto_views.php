<?php
  ...
  $resultado = $conectar->call_query($query);
   ...
   $guardar ="<form id='formulario' action='../producto/producto_data.php' method='post' enctype='multipart/form-data'>
     <section id='crear_producto'>
      <nav id='guardar'>
        ...
        <br />
        <button type='submit' name='actualizar' value='actualizar'>Grabar</button>
