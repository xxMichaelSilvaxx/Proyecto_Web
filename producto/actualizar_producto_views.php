      ...
      <form id="formulario" action="" method="POST" enctype="multipart/form-data">
        <section class="form-row">
          <div class="form-group col-15">
            ...
            <input id="id" type="text" name="id" clas s="form-control">
          </div>
        </section>
        <section class="form-row">
       ...
       <section class="form-row">
         <div class="form-group col-12">
          <button type="submit" id="actualizar" value="actualizar" class="btn btn-primary btn-block" onmousedown="Actualizar('actualizar', 'formulario', 'final')">Actualizar</button>
         </div>
         <div class="form-group col-12">
